    ...
    extend: {
      ...
      keyframes: {
        ...
        "ripple-keyframe": {
          ...
          "70%": { boxShadow: "0 0 0 15px rgba(230, 126, 34, 0)" },
      ...
      animation: {
        ...
        "float": "float-keyframe 3s ease-in-out infinite",
        "pulse": "pulse-keyframe 2s ease-in-out infinite",
        "ripple": "ripple-keyframe 1.5s ease-out infinite",
